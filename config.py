...
lp_dataset = dataset_base.copy({

  'name': 'License Plates',

  'train_info': '/content/drive/MyDrive/LicensePlateRec/annotations/train.json',
  'train_images': '/content/drive/MyDrive/LicensePlateRec/data/train',

  'valid_info': '/content/drive/MyDrive/LicensePlateRec/annotations/val.json',
  'valid_images': '/content/drive/MyDrive/LicensePlateRec/data/val',
...
yolact_resnet50_lp_config = yolact_resnet50_config.copy({
  'name':'yolact_resnet50_lp',
  'dataset':lp_dataset,
  'num_classes':len(lp_dataset.class_names) + 1,
  'max_size':512,
})
